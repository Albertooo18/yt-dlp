...
class Downloader:
    def __init__(self, update_progress, log, stop_event, show_progress):
        self.update_progress = update_progress  # callback GUI
        self.show_progress = show_progress      # callback GUI
        self.log = log
    ...
    def hook(self, d):
        ...
        # Primera actualización SIEMPRE permitida
        ...
        # Mostrar barra solo cuando empieza el progreso real
        self.show_progress()
